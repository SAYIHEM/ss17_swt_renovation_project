...
public class PaintTest {
    ...
    public void testConstructorIllegalArgument() {
        ...
        try {
            ...
            fail("Paint.Paint() should throw an IllegalArgumentException if the price argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
    }
    ...
    public void testConstructorNonpositiveArgument() {
        try {
            ...
            fail("Paint.Paint() should throw an IllegalArgumentException if the noOfCoats argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
        ...
        try {
            ...
            fail("Paint.Paint() should throw an IllegalArgumentException if the noOfSqMPerLiter argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
