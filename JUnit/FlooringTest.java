...
public class FlooringTest {
    ...
    public void testConstructorIllegalArgument() {
        ...
        try {
            ...
            fail("Flooring.Flooring() should throw an IllegalArgumentException if the price argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
    }
    ...
    public void testConstructorNonpositiveArgument() {
        try {
            ...
            fail("The constructor of Flooring should throw an IllegalArgumentException if the width argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
