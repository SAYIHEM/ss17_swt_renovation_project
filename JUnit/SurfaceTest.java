...
public class SurfaceTest {
    ...
    public void testConstructorNonpositiveArgument() {
        try {
            ...
            fail("Surface.Surface() should throw an IllegalArgumentException if the length argument is non-positive!");
        ...
        try {
            new Surface(2.0, -10.0);
            fail("Surface.Surface() should throw an IllegalArgumentException if the width argument is non-positive!");
        } catch (IllegalArgumentException e) {
        }
